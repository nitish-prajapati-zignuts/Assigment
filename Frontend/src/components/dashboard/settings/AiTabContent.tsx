  ...
  return (
    ...
    >
      ...
      <div className="bg-white dark:bg-zinc-950 rounded-3xl p-6 sm:p-8 border border-zinc-200 dark:border-zinc-800 shadow-xs space-y-5">
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            className="w-full text-xs sm:text-sm p-4 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:focus:ring-zinc-700 transition-all font-sans"
          />
          <p className="text-[11px] text-zinc-400">
            These instructions will be applied to all transcript processing requests.
          </p>
        </div>
        ...
        <div className="pt-2">
          ...
          <div className="flex flex-wrap gap-2.5">
            <button
              ...
              className="text-xs px-3.5 py-2 bg-zinc-100 dark:bg-zinc-900 hover:bg-zinc-200 dark:hover:bg-zinc-800 text-zinc-900 dark:text-zinc-100 rounded-xl font-semibold border border-zinc-200 dark:border-zinc-800 transition-all cursor-pointer shadow-2xs"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-zinc-950 rounded-3xl p-6 border border-zinc-200 dark:border-zinc-800 shadow-xs space-y-4">
              ...
              <button
                ...
                className={`py-2 px-3 text-xs font-bold rounded-xl border transition-all cursor-pointer ${
                  settings.summaryLength === len
                    ? "border-zinc-900 bg-zinc-900 text-white dark:border-zinc-100 dark:bg-zinc-100 dark:text-black shadow-xs"
        ...
        <div className="bg-white dark:bg-zinc-950 rounded-3xl p-6 border border-zinc-200 dark:border-zinc-800 shadow-xs space-y-4">
          ...
          <select
            ...
            className="w-full text-xs sm:text-sm p-3.5 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 focus:outline-none focus:ring-2 focus:ring-zinc-400 dark:focus:ring-zinc-700 transition-all cursor-pointer font-medium"
          >
